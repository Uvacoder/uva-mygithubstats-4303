...
import { bool, exact, number, shape, string } from 'prop-types';
        ...
        <div className="info-wrapper">
          <p>
            ...
            >
              ...
              &nbsp;
              <span>
                <ExternalLinkIcon width={14} height={14} className="block" />
              </span>
            </a>
          </p>
          ...
          <p className="stats">
            ...
            {Boolean(false) && (
              <span className="flex aic">
                ...
                <span className="tertiary-text">{data.issues.totalCount}</span>
              </span>
            )}
            {Boolean(false) && (
              <span className="flex aic">
