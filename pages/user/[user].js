  ...
  if (!data) {
    return (
      <div className={styles.loadingScreen}>
        ...
        <div>
          <div className="rel mb1 tertiary-text">
            <Loader size={44} strokeWidth={8} />
            <svg className="block" width="32" height="32" viewBox="0 0 24 24">
        ...
        <p className="secondary-text">
          fetching <span className="primary-text fw500">{username}</span>’s
          profile stats
        </p>
      </div>
    );
